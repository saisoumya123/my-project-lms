...
public class StudentDAOImp implements StudentDAO{
	...
	public BookBean searchBookTitle(String name) {
		...
		try {
			...
			throw new LMSException("Cannot find book with this name");
		}
		manager.close();
		factory.close();
	...
	public BookBean searchBookAuthor(String Author) {
		...
		try {
			...
			throw new LMSException("Cannot search book with this author");
		}
		manager.close();
		factory.close();
	...
	public boolean req(int id, int book_id) {
		...
		try {
			...
			throw new LMSException("Cannot request the book");
		}
		manager.close();
		factory.close();
	...
	public boolean reqReturnBook(int id, int book_id) {
		...
		try {
			...
			throw new LMSException("Cannot place return request of book");
		}
		manager.close();
		factory.close();
		return false;
